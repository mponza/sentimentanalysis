...
from liblinear.liblinear import parameter
from liblinear.liblinear import problem
...
class LinearClassifier(Classifier):
	...
	def train(self, labeled_featuresets):
		...
		y,x = svm_read_problem('../../tmp/svmFile')
		prob  = problem(y, x)
		param = parameter('-c 1 -q')
		self.__model = train(y,x)
	...
	def classify_set(self, featuresets):
		...
		y = [0]*len(x)
		p_labels = predict(y, x, self.__model)[0]
